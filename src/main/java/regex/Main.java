...
public class Main {
     ...
     * Only emails ending in @mail.utoronto.ca or @utoronto.ca
     * with at least one character before the @ are included.
    ...
    public static List<String> extractEmails(String str) {
        ...
        // and domain is either "utoronto.ca" or "mail.utoronto.ca".
    ...
    public static boolean checkForDoubles(String str) {
        // Capture an uppercase letter and check it appears again later
